...
<cffunction name="mergeSproc" output="false">

<cfargument name="sTableName" type="string" required="true">
<cfargument name="sSprocName" type="string" default="#arguments.sTableName##this.mergeSuffix#">
...
<cfargument name="sUdfName" type="string" default="#this.mergeSuffix#">
...
<cfif NOT listLen( arguments.lFilterFields )>
	<cfset request.log( "!!Error: No fields to filter by. [MergeSproc][#sTableName#]" )>
	<cfreturn>
	<cfthrow type="Custom.CFC.SprocGen.MergeSproc.NoFilterFields"
		message="No fields to filter by."
	>
<cfelseif NOT listLen( arguments.lUpdateFields )>
	<cfset request.log( "!!Error: No fields to update. [MergeSproc][#sTableName#]" )>
	<cfreturn>
	<cfthrow type="Custom.CFC.SprocGen.MergeSproc.NoUpdateFields"
		message="No fields to update."
	>
<cfelseif NOT listLen( arguments.lInsertFields )>
	<cfset request.log( "!!Error: No fields to insert. [MergeSproc][#sTableName#]" )>
	<cfreturn>
	<cfthrow type="Custom.CFC.SprocGen.MergeSproc.NoInsertFields"
...
<cfset this.appendBegin()>
	...
	<cfset this.append( "IF( @rowcount = 0 AND @error = 0 )" )>
...
<cfset this.addDefinition( "upsert", arguments, this.readBuffer( arguments.sSprocName ) )>
